...
package com.shengyu.tainlong.language.fragment
...
import com.shengyu.tainlong.databinding.DialogLanguageChooseBinding
import com.shengyu.tainlong.language.adapter.LanguageAdapter
import com.shengyu.tainlong.splash.SplashActivity
    ...
    override fun onCreateDialog(aSavedInstanceState: Bundle?): Dialog {
        ...
        if (aSavedInstanceState == null) {
            dialog.window?.setWindowAnimations(
                R.style.Theme_TainLong_CustomDialogFragment
            )
        } else {
            dialog.window?.setWindowAnimations(
                R.style.Theme_TainLong_CustomDialogFragment_Restore
            )
        }
